...
{
    if (((AppDelegate *)[UIApplication sharedApplication].delegate).inNightMode) {
        return [UIColor colorWithRed:139.0/255 green:207.0/255 blue:50.0/255 alpha:1.0];
    }
    return [UIColor colorWithHex:0x8bcf32];
}
...
+ (UIColor *)selectTitleBarColor
{
    ...
    if (((AppDelegate *)[UIApplication sharedApplication].delegate).inNightMode) {
        return  [UIColor colorWithRed:0.545 green:0.812 blue:0.196 alpha:1.0];
    }
...
+ (UIColor *)navigationbarColor
{
    ...
    return [UIColor colorWithHex:0x8bcf32];//0x8bcf32
}
